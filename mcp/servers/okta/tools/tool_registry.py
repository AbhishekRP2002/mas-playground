...
class ToolRegistry:
    ...
    def register_elicitation_capabilities(self, registry):
        ...
        try:
            from mcp.servers.okta.capabilities.elicitation import register_elicitation_workflows, is_elicitation_available
    ...
    def register_sampling_capabilities(self, server: FastMCP, model_provider=None):
        ...
        try:
            from mcp.servers.okta.capabilities.sampling import register_sampling_capabilities
